...
public class ServiceFactory {
    ...
    public ResponseOptions<Response> ExecuteAPIWithoutParameters() {
        return ExecuteAPI();
    }
     ...
     * @return Response
     */
    public ResponseOptions<Response> ExecuteAPIWithPathParamsAndBody(Object body, Map<String, String> pathPar) {
        builder.setBody(body);
